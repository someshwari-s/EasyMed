...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-md navbar-light py-3">
    <div class="container">
      <a class="navbar-brand" href="AdminLogin.html"><img src="assets/images/award.png" class="img-fluid" width="52px">
        GraminArogya</a>
		...
		<div class="container py-lg-5 py-sm-3">
			<div class="apply-grids-info row">
				<div class="apply-gd-left col-lg-5">
					<h4>Add Doctor</h4>
					<p class="para-apply">Add Doctor Here
					...
					<div class="apply-form p-sm-5 p-4">
						...
						<form action="AddDoctor" method="post">
							<div class="admission-form">
								...
								<select class="form-control" name="symptoms1" required>
									...
									try
									{
										...
										PreparedStatement ps = con.prepareStatement("SELECT DISTINCT Col1 FROM ohas_dataset");
