<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="get.Geta"%>
    <%@page import="get.arogyaname"%><!--
Author: W3layouts
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
                  <a class="nav-link" href="ArogyaMenu.jsp">Add Patients</a>
          </li>
         <li class="nav-item">
			...
			<div class="apply-grids-info row">
				...
				<div class="apply-gd-right offset-lg-1 col-lg-6 mt-lg-0 mt-5">
					<div class="apply-form p-sm-5 p-4">
						...
						<form action="UpdatedComment" method="post">
