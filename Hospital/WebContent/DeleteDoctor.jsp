    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="AddDoctor.html">AddDoctor</a>
          </li>
           <li class="nav-item">
                  <a class="nav-link" href="DeleteDoctor.jsp">ViewDoctor</a>
          </li>
          ...
          <li class="nav-item active">
                  <a class="nav-link" href="DeleteArogya.jsp">ViewArogya</a>
          </li>
          <li class="nav-item">
...
<div class="banner-info-bg">
				<table border="1" id="displaytable" class="table table-bordered" style="displaynone" >
         <thead>
         <tr>
         <td><h3><b>EID</b></h3></td>
                                                 <td><h3><b>NAME</b></h3></td>
                                                   <td><h3><b>password</b></h3></td>
                                                    <td><h3><b>Specialist</b></h3></td>
                                  ...
                                  <td><%out.print(rs.getString(3)); %></td>
                                   ...
                                   <td><a href="DFile.jsp/?=<%=rs.getInt("did") %>" onclick="return confirm_alert(this);">Delete</a></td>                             
                                                    </tr>
                                          </tbody>
                                                   <%
                                                   }
