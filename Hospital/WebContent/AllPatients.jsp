...
<section class="ftco-section">
		<div class="container">
         ...
         <tr>
                                         ...
                                         Connection con=null;
                                         String aid=arogyaname.getAemail();
                                          Class.forName("com.mysql.jdbc.Driver");
      									System.out.println("Class execute");
      									con=DriverManager.getConnection("jdbc:mySql://localhost:3306/hospital","root","");
      									Statement stmt=con.createStatement();
      									
      									ResultSet rs=stmt.executeQuery("select * from patient where aid='"+aid+"'");
                                          while(rs.next()){
                                          %>
                                          <tbody>
                                                    <tr>
							                                   ...
							                                   <td><%out.print(rs.getString(8)); %></td>
                                                    			<td><a href="Download.jsp?id=<%=rs.getInt("id")%> "onclick="return confirm_alert(this);">DownloadPrecription</a></td>
