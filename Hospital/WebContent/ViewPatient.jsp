...
<section class="ftco-section">
		<div class="container">
         ...
         <tr>
                                                 ...
                                                 <td><h3><b>PreDisease</b></h3></td>
                                                 <td><h3><b>Prescription</b></h3></td>
                                                  <td><h3><b>Comment</b></h3></td>
                                         ...
                                         Connection con=null;
      									...
      									String did = (String)request.getAttribute("myname");
      									
      									ResultSet rs=stmt.executeQuery("select * from patient where did='"+did+"'");
                                          while(rs.next()){
                                          %>
                                          <tbody>
                                                    <tr>
							                                   ...
							                                   <td><%out.print(rs.getString(12)); %></td>
                                   							  <td><a href="UploadPre.jsp?id=<%=rs.getInt("id")%> "onclick="return confirm_alert(this);">Add Prescription</a></td>
                                   
                                   <td><a href="commentDc.jsp?id=<%=rs.getInt("id")%> "onclick="return confirm_alert(this);">Add Comment</a></td>
